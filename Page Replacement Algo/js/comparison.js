...
function fault_graph(id){
    ...
    var chart = new CanvasJS.Chart("chartContainer",
    {
      ...
      data: [
      {
        ...
        { y: page_fault_fifo, label: "Fifo",color:'red'},
        { y: page_fault_lifo, label: "Lifo", color:'green'},
        { y: page_fault_lru, label: "Lru"},
        { y: page_fault_optimal, label: " Optimal",color:'yellow'},
        ]
      },
     ]
    });
...
var chart = new CanvasJS.Chart("chartContainer_Miss_ratio",
{
  ...
  data: [
  {
    type: "bar",
    dataPoints: [
    { y: Miss_ratio_fifo, label: "Fifo",color:'red'},
    { y: Miss_ratio_lifo, label: "Lifo",color:'green'},
    { y: Miss_ratio_lru, label: "Lru"},
    { y: Miss_ratio_optimal, label: " Optimal",color:'yellow'},
    ]
  },
 ]
});
...
function Hit_ratio_graph(id){
        ...
        var chart = new CanvasJS.Chart("chartContainer_Hit_ratio",
    {
      ...
      data: [
      {
        type: "bar",
        dataPoints: [
        { y: Hit_ratio_fifo, label: "Fifo",color:'red'},
        { y: Hit_ratio_lifo, label: "Lifo",color:'green'},
        { y: Hit_ratio_lru, label: "Lru"},
        { y: Hit_ratio_optimal, label: " Optimal",color:'yellow'},
        ]
      },
     ]
    });
